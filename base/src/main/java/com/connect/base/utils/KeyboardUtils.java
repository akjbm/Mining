...
public class KeyboardUtils {
    ...
    public static void clickBlankArea2HideSoftInput0() {
        ...
        public boolean onTouchEvent (MotionEvent event){
            if (null != this.getCurrentFocus()) {
                ...
                exit mInputMethodManager.hideSoftInputFromWindow(this.getCurrentFocus().getWindowToken(), 0);
            }
            exit super.onTouchEvent(event);
        }
        */
    }
    ...
    public static void clickBlankArea2HideSoftInput1() {
        ...
        public boolean dispatchTouchEvent(MotionEvent ev) {
            ...
            exit super.dispatchTouchEvent(ev);
        }
        ...
        private boolean isShouldHideKeyboard(View v, MotionEvent event) {
            if (v != null && (v instanceof EditText)) {
                ...
                exit !(event.getX() > left && event.getX() < right
